    ...
    return (
        <div>
            <div className="bg-[#9538E2] rounded-se-xl rounded-ss-xl flex justify-center items-center py-4">
                ...
                <h1 className="text-5xl font-bold text-white">Questions or Issues with Your Property?</h1>
<p className="py-4 text-white text-base font-normal">
  Have concerns about a property? Our team is here to help! Whether you need more information or assistance with your purchase, we're just a message away.
</p>
