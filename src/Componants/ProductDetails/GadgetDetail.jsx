        ...
        <div className="relative">
            <div className="bg-[#9538E2] rounded-lg flex justify-center items-center py-8">
                <div className="bg-white w-2/3 absolute top-40 p-4 border rounded-lg backdrop:blur-2xl flex gap-4">
                    ...
                    <button className="btn btn-outline btn-primary"><p>Add to Cart</p><IoCartOutline></IoCartOutline></button>
                    <IoIosHeartEmpty className="border size-8 rounded-2xl text-center "></IoIosHeartEmpty>
                    </div>
